...
export const metadata: Metadata = {
  title: 'Terms of Service | InvoicePDF',
  description: 'Read the Terms of Service for InvoicePDF.',
    ...
    <div className="container mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="prose prose-stone dark:prose-invert max-w-none space-y-4">
        ...
        <p>
          ...
          carefully before using the [Your Website URL] website (the "Service")
          operated by InvoicePDF ("us", "we", or "our").
        </p>
        <p>
        ...
        <p>
          ...
          and will remain the exclusive property of InvoicePDF and its
        ...
        <p>
          ...
          that are not owned or controlled by InvoicePDF... [Add disclaimer about
          third-party links.]
        </p>
